"""Auto-generated Ray Serve deployment for standard_train_serve.
...
app = FastAPI(
    title="standard_train_serve Ray Serve API",
    version="1.0.0",
)
...
def main() -> None:
    ...
    # Bind services
    config_path = "mlproject/configs/pipelines/standard_train.yaml"
