"""Auto-generated Ray Serve deployment for parallel_ensemble_serve.
...
app = FastAPI(
    title="parallel_ensemble_serve Ray Serve API",
    version="1.0.0",
)
...
class ModelService:
    ...
    def _load_models(self) -> None:
        ...
        # Load models
        self.models["fitted_xgboost_branch"] = self.mlflow_manager.load_component(
...
class ServeAPI:
    ...
    def __init__(
        ...
        self.cfg = ConfigLoader.load(""mlproject/configs/pipelines/parallel_ensemble.yaml"")
...
def main() -> None:
    ...
    # Bind services
    config_path = "mlproject/configs/pipelines/parallel_ensemble.yaml"
