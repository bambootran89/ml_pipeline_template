"""Auto-generated Ray Serve deployment for nested_suppipeline_serve.
...
app = FastAPI(
    title="nested_suppipeline_serve Ray Serve API",
    version="1.0.0",
)
...
class ModelService:
    ...
    def _load_models(self) -> None:
        ...
        experiment_name = self.cfg.experiment.get("name", "nested_suppipeline_serve")
...
class ServeAPI:
    ...
    def __init__(
        ...
        self.cfg = ConfigLoader.load(""mlproject/configs/pipelines/nested_suppipeline.yaml"")
...
def main() -> None:
    ...
    # Bind services
    config_path = "mlproject/configs/pipelines/nested_suppipeline.yaml"
