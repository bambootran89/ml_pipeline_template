"""Auto-generated Ray Serve deployment for dynamic_adapter_train_serve.
...
app = FastAPI(
    title="dynamic_adapter_train_serve Ray Serve API",
    version="1.0.0",
)
...
class ModelService:
    ...
    def _load_models(self) -> None:
        ...
        experiment_name = self.cfg.experiment.get("name", "dynamic_adapter_train_serve")
...
class ServeAPI:
    ...
    def __init__(
        ...
        self.cfg = ConfigLoader.load(""mlproject/configs/pipelines/dynamic_adapter_train.yaml"")
...
def main() -> None:
    ...
    # Bind services
    config_path = "mlproject/configs/pipelines/dynamic_adapter_train.yaml"
