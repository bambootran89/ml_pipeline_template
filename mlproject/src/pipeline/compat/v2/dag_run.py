...
Training::
    ...
    python -m mlproject.src.pipeline.compat.v2.dag_run train \
        --experiment mlproject/configs/experiments/etth3.yaml \
        --pipeline mlproject/configs/pipelines/standard_train.yaml

Evaluation::

    python -m mlproject.src.pipeline.compat.v2.dag_run eval \
        --experiment mlproject/configs/experiments/etth3.yaml \
        --pipeline mlproject/configs/pipelines/standard_eval.yaml

Serving::

    python -m mlproject.src.pipeline.compat.v2.dag_run serve \
        --experiment mlproject/configs/experiments/etth3.yaml \
...
Hyperparameter Tuning::
    ...
    python -m mlproject.src.pipeline.compat.v2.dag_run tune \
        --experiment mlproject/configs/experiments/etth3.yaml \
...
from mlproject.src.pipeline.compat.v2.flexible_pipeline import FlexiblePipeline
